...
let isInMotto=coolIndex>0;
console.log(isInMotto);
...
let newMottoLength=newMotto.length;
let lengthRatio=(newMottoLength/mottoLength)*100;
let ratio=lengthRatio.toFixed(2) + '%';
console.log(ratio);
...
let indexFour=numbers.indexOf(4);
numbers[indexFour]=4.2;
console.log(numbers);
