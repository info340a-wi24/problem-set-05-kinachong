...
function mostYardsPassing(game1, game2) {
  const passingYards1 = game1.passing_yards || 0;
  const passingYards2 = game2.passing_yards || 0;

  return passingYards1 >= passingYards2 ? game1 : game2;
}
...
const gamesLostWithFumbles = huskyGames2016.filter(fumbledAndLostFilter);
